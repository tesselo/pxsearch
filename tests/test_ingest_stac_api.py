...
def test_ingest_stac_collections(requests_mock, test_db_session):
...
def test_ingest_stac_day(requests_mock, test_db_session):
    item, collection = setup_stac_requests_mock(requests_mock)
...
def test_ingest_stac_year(requests_mock, test_db_session):
    item, collection = setup_stac_requests_mock(requests_mock)
